...
var Mongo = function(config) {
	...
	this.config = config;
	this.models = { };
	this.config.schemaRoot = this.config.schemaRoot || path.join(process.cwd(), 'schemas/mongo');
...
Mongo.prototype.applySchemas = utils.schemasWalkWrapper(mongoose, mongoose.model);
